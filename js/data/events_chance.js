...
const EVENTS_CHANCE = [
...

  {
    ...
    weight: 7,
    trigger: { maxTIS: 48, notDeployed: true },
    isChance: true,
...

  {
    ...
    weight: 6,
    trigger: { maxSavings: 16000, bahEligible: true },  // a rate dip only stings when margins are tight
    isChance: true,
...

  {
    ...
    weight: 3,
    trigger: { minDisciplineRisk: 50, notDeployed: true },
    isChance: true,
...

  {
    ...
    weight: 2,
    trigger: { minDisciplineRisk: 60, notDeployed: true },
    isChance: true,
